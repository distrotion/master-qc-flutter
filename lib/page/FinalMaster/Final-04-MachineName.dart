...
class FnlMachineNameTable extends StatefulWidget {
  FnlMachineNameTable({Key? key, this.data}) : super(key: key);
  mapdataset? data;

  @override
  _FnlMachineNameTableState createState() => _FnlMachineNameTableState();
}

class _FnlMachineNameTableState extends State<FnlMachineNameTable> {
  ...
  void initState() {
    ...
    context.read<Final_Bloc>().add(Final_MACHINE_flush());
  }
