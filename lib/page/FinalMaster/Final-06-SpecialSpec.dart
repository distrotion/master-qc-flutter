...
class FnlSpeciSPeTable extends StatefulWidget {
  FnlSpeciSPeTable({Key? key, this.data}) : super(key: key);
  mapdataset? data;

  @override
  _FnlSpeciSPeTableState createState() => _FnlSpeciSPeTableState();
}

class _FnlSpeciSPeTableState extends State<FnlSpeciSPeTable> {
  ...
  void initState() {
    ...
    context.read<Final_Bloc>().add(Final_SPECIFICATION_flush());
  }
